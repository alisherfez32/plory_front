<template>
    <div class="flex flex-col w-full justify-center items-center">
        ...
        <p class="font-semibold md:w-3/5 m-1.5 text-center mb-2">The go to restaurants in Jakarta loved by locals and expats! With the majority of Muslims, you will not have a hard time finding Halal restaurant.</p>
